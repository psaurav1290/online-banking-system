...
//	
	...
	public void testLogin() throws Exception {
		...
		cust.setPassword("kt@123");
		 ...
		 Mockito.when(custService.validateCustomer(ArgumentMatchers.any())).
...
.andExpect(jsonPath("$.dob",Matchers.equalTo(cust.getDob())));
	...
	public void testSaveAdmin() throws Exception {
		...
		adm.setPassword("ktktktktkt");
		 ...
		 Mockito.when(adService.saveAdmin(ArgumentMatchers.any())).
	...
	public void testAdminLogin() throws Exception {
		...
		adm.setPassword("ktktktktkt");
		 ...
		 Mockito.when(adService.adminLogin(ArgumentMatchers.any())).
		 thenReturn(adm.toString());
